...
public class ContextUtils {
    ...
    public static Optional<PagedGui<?>> getPagedGui(@NotNull Context ctx) {
        return cn.encmys.ykdz.forest.hypharepo.utils.ContextUtils.getMember(ctx, "__gui", PagedGui.class);
    }

    public static Optional<ShopOrder> getShopOrder(@NotNull Context ctx) {
        return cn.encmys.ykdz.forest.hypharepo.utils.ContextUtils.getMember(ctx, "__order", ShopOrder.class);
    }
    ...
    public static Optional<ScrollGui<?>> getScrollGui(@NotNull Context ctx) {
        return cn.encmys.ykdz.forest.hypharepo.utils.ContextUtils.getMember(ctx, "__gui", ScrollGui.class);
    }
    ...
    public static Optional<Shop> getShop(@NotNull Context ctx) {
        return cn.encmys.ykdz.forest.hypharepo.utils.ContextUtils.getMember(ctx, "__shop", Shop.class);
    }
    ...
    public static Optional<Product> getProduct(@NotNull Context ctx) {
        return cn.encmys.ykdz.forest.hypharepo.utils.ContextUtils.getMember(ctx, "__product", Product.class);
    }

    public static Optional<Item> getIcon(@NotNull Context ctx) {
        return cn.encmys.ykdz.forest.hypharepo.utils.ContextUtils.getMember(ctx, "__icon", Item.class);
    }
}